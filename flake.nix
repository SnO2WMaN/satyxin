{
  ...
  inputs = {
    ...
    pkg-satysfi-class-stjarticle.url = "github:puripuri2100/stjarticle"; # untagged
    ...
    pkg-satysfi-easytable.url = "github:monaqa/satysfi-easytable/v1.1.2"; # untagged
    ...
    pkg-satysfi-fonts-junicode.url = "github:na4zagin3/SATySFi-fonts-junicode"; # can't because v1.0002+satysfi0.0.5 contains `+`
    pkg-satysfi-fss.flake = false;
    pkg-satysfi-fss.url = "github:na4zagin3/satysfi-fss/v0.2.0";
    pkg-satysfi-karnaugh.flake = false;
    pkg-satysfi-karnaugh.url = "github:takagiy/satysfi-karnaugh"; # untagged
